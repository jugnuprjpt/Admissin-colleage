...
function BasicInformation() {
  return (
    <>
    <div class="container">
  <a href="#"><img src="https://s26.postimg.org/kd8zstg15/Top_Header.jpg" alt="img/TopHeader.jpg" class="img-thumbnail"/></a>
</div>
    ...
    <div class="col-lg-8 col-lg-offset-2 well">
      <div class="panel panel-info">
        <div class="panel-heading">
          <h3 class="panel-title text-center">Application for Admission in &nbsp;
                            <font color="blue">ARTS & COMMERCE </font>
                           
                            <font color="blue">Colleage</font> - APRIL 2024</h3>
                    </div>
                     <div class="panel-body">
                         ...
                         <div class="form-horizontal row">
                            <div class="form-group">
                                <label for="applicant_name" class="control-label col-sm-3">Name Of the Student:</label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="mobile">Pranet's Mobile :</label>
                                <div class="col-sm-4">
                                    <div class="input-group">
                            ...
                            <div class="form-group">
                                <label for="blood_group" class="control-label col-sm-3">Miniority :</label>
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-3">
                                    <select name="nationality" id="nationality" class="form-control">
                                                            ...
                                                            <option value="BANGLADESHI" selected>Indian</option>
                                                        </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="blood_group" class="control-label col-sm-3">Disibility :</label>
                                <div class="col-sm-2">
                                    <select name="blood_group" id="blood_group" class="form-control">
                                                        <option value="">Select</option>
                                                        <option value="YES">YES</option>
                                ...
                                <label for="nationality" class="control-label col-sm-2">Category :</label>
                                <div class="col-sm-3">
                                    <select name="nationality" id="nationality" class="form-control">
                                                            <option value="">Select</option>								
                                                            <option value="BANGLADESHI" selected>General</option>
                                                            <option value="BANGLADESHI" selected>SEBC</option>
                                                            <option value="BANGLADESHI" selected>EWS</option>
                                                            <option value="BANGLADESHI" selected>SC</option>
                                                            <option value="BANGLADESHI" selected>ST</option>
                            ...
                            <div class="form-group">
                                <label for="national_id" class="control-label col-sm-3">Aadhaar ID :</label>
                                <div class="col-sm-6">
                            ...
                            <fieldset>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="hsc_roll_no" class="control-label col-sm-4">Seat No :</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="form-group">
                                                    <label for="hsc_roll_no" class="control-label col-sm-4">Passing Year :</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="hsc_roll_no" id="ssc_roll_no" class="form-control"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-4" for="hsc_result">Total Marks :</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-4" for="hsc_result">Obtain Marks :</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-4" for="hsc_result">No of Trial :</label>
                                                    <div class="col-sm-8">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h5 class="panel-title text-center">Masters Level (if any)</h5>
                                            </div>
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <label for="ms_exam_type" class="control-label col-sm-2">Examination</label>
                                                    <div class="col-sm-4">
                                                    ...
                                                    <label class="control-label col-sm-2" for="ms_result">Result</label>
                                                    <div class="col-sm-4">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">GPA</span>
                                                            <input type="number" name="ms_result" class="form-control" id="ms_result" step="0.01" min="1" max="5"/>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="ms_subject" class="control-label col-sm-2">Subject</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" name="ms_subject" id="ms_subject" class="form-control"/>
                                                    </div>

                                                    <label class="control-label col-sm-2" for="ms_pass_year">Passing Year</label>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="ms_university" class="control-label col-sm-2">University</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" name="ms_university" id="ms_university" class="form-control"/>
                                                    </div>

                                                    <label class="control-label col-sm-2" for="ms_duration">Course Duration</label>
                                                    <div class="col-sm-4">
